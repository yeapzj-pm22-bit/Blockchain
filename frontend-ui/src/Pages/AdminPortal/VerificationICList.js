  ...
  return (
    <div className="container-fluid">
      ...
      <Modal
        ...
        okText="Submit"
        cancelText="Cancel"
        okButtonProps={{ disabled: approvalStatus === 'rejected' && rejectionReason.trim() === '' }}
      >
        <p><strong>Patient Name:</strong> Yeap Zi</p>
        <div className="d-flex justify-content-between mb-3">
          <div style={{ textAlign: 'center' }}>
            <label className="form-label d-block">Front IC Image</label>
            <Image src={userImg} width={200} style={{ border: '1px solid #ccc', borderRadius: 5 }} />
          </div>
          <div style={{ textAlign: 'center' }}>
            <label className="form-label d-block">Back IC Image</label>
            <Image src={userImg} width={200} style={{ border: '1px solid #ccc', borderRadius: 5 }} />
          </div>
        </div>
